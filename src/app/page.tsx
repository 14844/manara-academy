                ...
                <div>
                    ...
                    <ul className="space-y-3 text-sm text-muted-foreground">
                        <li className="flex items-center gap-2">
                            ...
                            <a href="tel:01017333215" dir="ltr" className="hover:text-primary transition-colors">01017333215</a>
                        </li>
                        <li className="flex items-center gap-2">
                            ...
                            <a href="mailto:manaraacademyplatform@gmail.com" className="hover:text-primary transition-colors">manaraacademyplatform@gmail.com</a>
                        </li>
                        <li className="flex items-center gap-2">
