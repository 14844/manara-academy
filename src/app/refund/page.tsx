            ...
            <main className="flex-1 container py-16 max-w-4xl mx-auto">
                ...
                <div className="prose prose-slate dark:prose-invert max-w-none space-y-8 text-muted-foreground leading-loose">
                    <section>
                        ...
                        <p>نظراً لطبيعة المنتجات الرقمية والمحتوى التعليمي المُقدم عبر منصتنا والذي يُعتبر (منتجات غير ملموسة)، فإننا نتبع سياسة صارمة بشأن الاسترجاع:</p>
                        <ul className="list-disc pr-6 mt-4 space-y-2">
                            <li className="font-bold text-red-600">لا يمكن استرجاع قيمة الكورس بأي حال من الأحوال بمجرد شراء الكورس والبدء في مشاهدة المحتوى التعليمي.</li>
                            <li>يُعتبر اشتراك الطالب وموافقته على الخصم من رصيد محفظته لشراء كورس معين عملية نهائية.</li>
                            <li>حق استرداد القيمة متاح فقط في حالة حدوث خلل تقني جسيم من جانب المنصة يمنع وصول الطالب للخدمة بشكل كامل وتعذر حله من قبل الدعم الفني.</li>
                        </ul>
                    </section>
